...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2020 at 08:46 AM
...
ALTER TABLE `customers`
  ...
  ADD KEY `fk_orderdetails_salesRepEmployeeNumber` (`salesRepEmployeeNumber`);
...
ALTER TABLE `orderdetails`
  ...
  ADD KEY `fk_orderdetails_productCode` (`productCode`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `fk_orders_customerNumber` (`customerNumber`);
