...
{
    function target_user($id_kegiatan = null,$id_user = null)
    {
        // SELECT id_kegiatan,id_user,target FROM `kegiatan_detail` where id_kegiatan = 1 and id_user =3
        $CI =& get_instance();
        $CI->db->select('target');
...
{
    function realisasi_user($id_kegiatan = null,$id_user = null)
    {
